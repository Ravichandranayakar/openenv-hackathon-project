...
class MultiAgentGRPOTrainer:
    ...
    def load_and_optimize_model(self, agent_name: str) -> Tuple:
        ...
        model, tokenizer = FastLanguageModel.from_pretrained(
            ...
            max_seq_length=2048,
            dtype=torch.float16,    # float16: consistent with Unsloth LoRA kernels, no bitsandbytes needed
            load_in_4bit=False,     # 79GB A100 has plenty of VRAM for 8B in float16 (~16GB)
        )
